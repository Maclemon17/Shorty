...
const ActionCall = () => {
    return (
        <section className="px-10 py-10 lg:px-44 absolute w-full h-fit left-0 -top-30" id="action-call">
            <div className="w-full mx-auto flex flex-col md:flex-row justify-between items-center gap-5 px-5 md:px-20 py-7 md:py-15 rounded-2xl bg-[url(/src\assets\images\bg-shorten-mobile.svg)] bg-contain md:bg-[url(/src\assets\images\bg-shorten-desktop.svg)] md:bg-cover bg-right bg-no-repeat bg-dark-violet">
